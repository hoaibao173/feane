...
//nếu tồn tại biến loại sản phẩm thì lấy dữ liệu
...
//Nếu kiểm tra có thương hiệu thì mình lấy
...
//kiểm tra nếu có sản phẩm trả về thì mình lấy (9 sản phẩm đầu tiên)
...
//kiểm tra nếu có chọn loại sản phẩm hay thương hiệu hoặc tìm kiếm từ khóa thì mình lấy dữ liệu và trả về 
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
    ...
    if (isset($_POST["checkOutDetails"])) {
		if (mysqli_num_rows($query) > 0) {
			//Hiển thị mục giỏ hàng của người dùng với nút "Sẵn sàng thanh toán" nếu người dùng chưa đăng nhập
			echo '<div class="main ">
