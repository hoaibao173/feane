$(document).ready(function() {
    ...
    //cat() là một hàm tìm nạp bản ghi danh mục từ cơ sở dữ liệu bất cứ khi nào trang được LOAD
    function cat() {
        $.ajax({
            url: "action.php",
            method: "POST",
    ...
    //brand() là một hàm tìm nạp bản ghi thương hiệu từ cơ sở dữ liệu bất cứ khi nào trang được LOAD
    function brand() {
        $.ajax({
            url: "action.php",
            method: "POST",
    ...
    //product() là một chức năng tìm nạp bản ghi sản phẩm từ cơ sở dữ liệu bất cứ khi nào trang được LOAD
    function product() {
        $.ajax({
            url: "action.php",
            method: "POST",
    ...
    /*	khi tải trang thành công thì sẽ có danh sách các danh mục 
    	khi người dùng nhấp vào danh mục chúng ta sẽ nhận được id danh mục và
    ...
    */
    ...
    /*	khi tải trang thành công thì sẽ có danh sách các thương hiệu 
    	khi người dùng nhấp vào thương hiệu, chúng tôi sẽ nhận được id thương hiệu và
    ...
    */
    $("body").delegate(".selectBrand", "click", function(event) {
        ...
        /*
        	Ở đầu trang có hộp tìm kiếm với nút tìm kiếm 
        	khi người dùng nhập tên sản phẩm thì chúng tôi sẽ đưa người dùng
        	chuỗi đã cho và với sự trợ giúp của truy vấn sql, 
        	chúng tôi sẽ đối sánh chuỗi do người dùng cung cấp với cột từ khóa cơ sở dữ liệu của chúng tôi sau đó đối sánh sản phẩm
    ...
    /*
    	Ở đây #login là id biểu mẫu đăng nhập và biểu mẫu này có sẵn trong trang index.php
    ...
    */
    ...
    //Nhận thông tin người dùng trước khi thanh toán
    ...
    //Tìm nạp mục Giỏ hàng từ Cơ sở dữ liệu đến menu thả xuống
    getCartItem();
